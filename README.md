...
**This repository is a slight modification of the [word-level language modeling RNN PyTorch example](https://github.com/pytorch/examples/tree/master/word_language_model).**
...
python main.py --emsize 1500 --nhid 1500 --dropout 0.65 --epochs 40
```
